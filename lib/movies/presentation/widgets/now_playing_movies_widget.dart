...
class NowPlayingMoviesWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MoviesBloc, MoviesState>(
     ...
     // log(state.popularMoviesState.toString());
              ...
              items: state.nowPlayingMoviesList.map(
                (item) {
                  return GestureDetector(
                    ...
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (BuildContext context )=>MovieDetailsScreen(id: item.id) ));
                    ...
                    child: Stack(
                      children: [
                        ShaderMask(
                          ...
                          child: (item.backdropPath == "") ?  Container(
                          height: 560.0,
